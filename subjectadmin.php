...
<div class="dvcontent">
  <div>
    <div class="tabs">
      <div class="hd">
        <ul style="">
          <li style="box-sizing: initial;-webkit-box-sizing: initial;" class="on">查看学科</li>
...
{
    $id = $row['id'];
   echo"<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>"."<a href='del_subject.php?id=$id'>删除</a>"."</td></tr>";
   }
?>
              </table>
            </div>
                  ...
                  <div class="am-g">
                    ...
                    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
                      ...
                      <form style="text-align: center" class="am-form am-form-horizontal"
							action="subjection.php" method="post">
                        <div class="am-form-group">
                          <label for="user-intro" class="am-u-sm-3 am-form-label"> 学科号</label>
                          <div class="am-u-sm-9">
                            <input type="text" id="id" name="id">
                          </div>
                        </div>
                        <div class="am-form-group">
                          <label for="user-name" class="am-u-sm-3 am-form-label"> 学科名</label>
                          <div class="am-u-sm-9">
