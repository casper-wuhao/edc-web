...
<div class="dvcontent">
  <div>
    <div class="tabs">
      <div class="hd">
        <ul style="">
          <li style="box-sizing: initial;-webkit-box-sizing: initial;" class="on">查看教师</li>
          <li class="" style="box-sizing: initial;-webkit-box-sizing: initial;">添加教师</li>
        </ul>
      </div>
      <div class="bd">
...
{
    $id = $row['id'];
   echo"<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["password"]."</td><td>"."<a href='del_teacher.php?id=$id'>删除</a>"."</td></tr>";
   }
?>
</table>
                  ...
                  <div class="am-g">
                    ...
                    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
                      ...
                      <form style="text-align: center" class="am-form am-form-horizontal"
							action="teachertion.php" method="post" enctype="multipart/form-data">
