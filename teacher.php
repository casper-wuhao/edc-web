...
<div class="dvcontent">
    ...
    <li class="limenuitem"> <i class="icon-cog menuicon"></i>教师系统<b class="arrow icon-angle-down arrow-down"></b>
              <ul class="ulleftsubitems">
        
                <a href="paperadmin.php" target="right">
                <li>试卷管理</li>
                </a> <a href="correctpaper.php" target="right">
                <li>试卷批改</li>
                </a> <a href="scoreadmin.php" target="right">
                <li>成绩统计</li>
                </a>
      </ul>
            </li>
    ...
    <iframe src="paperadmin.php" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
  </div>
        </div>
