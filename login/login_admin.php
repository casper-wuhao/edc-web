...
<div class="login_box">
  ...
  <div class="login">
    ...
    <div class="login_name">
        <p style="font-family:'fz'">系统登录 管理员</p>
    </div>
    <form method="post" action="logintion_admin.php">
      <input style="font-family: 'zz'" name="username" type="text"  value="用户名" onfocus="this.value=''" onblur="if(this.value==''){this.value='用户名'}">
