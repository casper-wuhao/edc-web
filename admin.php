...
<div class="dvheader">
  <div class="dvheadertools"> <span class="headerspantitle">在线考试系统</span>
    <ul class="headerultools">
      <a href="login/login.php">▶注销</a>
    </ul>
  </div>
</div>
<div class="dvcontent">
  <ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
    <li class="limenuitem"> <i class="icon-cog menuicon"></i>管理员系统<b class="arrow icon-angle-down arrow-down"></b>
      <ul class="ulleftsubitems">
        <a href="studentadmin.php" target="right">
        <li>学生管理</li>
        </a> <a href="teacheradmin.php" target="right">
        <li>教师管理</li>
        </a><a href="subjectadmin.php" target="right">
        <li>课堂管理</li>
        </a>
      </ul>
    </li>
  ...
  <div style="position: absolute; left: 191px; right: 20px; ">
    <iframe src="studentadmin.php" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
  </div>
</div>
