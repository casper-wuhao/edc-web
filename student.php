...
<div class="dvcontent">
  <ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
    <li class="limenuitem"> <i class="icon-cog menuicon"></i>学生系统<b class="arrow icon-angle-down arrow-down"></b>
      <ul class="ulleftsubitems">
        <a href="kaoshi/index.php" target="right">
        <li>参加考试</li>
        </a> <a href="kaoshi/total.php" target="right">
        <li>查看成绩</li>
        </a>
      </ul>
    </li>
  ...
  <div style="position: absolute; left: 191px; right: 20px; ">
    <iframe src="xxxxxxxxxxxxxxxxxxxxxxxxxxx" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
  </div>
</div>
